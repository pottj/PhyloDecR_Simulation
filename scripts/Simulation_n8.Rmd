...
I want to run a simulation for n=8 taxa. There are 70 possible quadruples with n=8 taxa, and I want to test all possible combinations for k out of 70 quadruples for phylogenetic decisiveness.
...
In *myTab_n8*, there are all possible Four-way-partitions (4WP) given n=8 taxa. 

In *quadruple_data*, there are all possible quadruples given n=8 taxa. 
