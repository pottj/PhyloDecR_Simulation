...
save(SimulationResults_n7, file = "../results/SimulationResults_n6.RData")

plot(SimulationResults_n7$k,SimulationResults_n7$negRate)
plot(SimulationResults_n7$k,SimulationResults_n7$posRate)
