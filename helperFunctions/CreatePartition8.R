#' ---
#' title: "Creating all 4WPs for n=8"
...
#' 
#' According to Stirling numbers of the second kind, there are 1701 different partitions for 8 taxa. 
#' 
...
#' 
test1 = createInput(fn="../testData/Smin8_notDecisive.txt",sepSym = "_")
test2 = createInput(fn="../testData/S8_notDecisive.txt",sepSym = "_")
test3 = createInput(fn="../testData/S8_Decisive.txt",sepSym = "_")
...
#' 
#' * as stated in my thesis, only test3 is decisive, but still not resolvable by Fischers Algorithm
#' 
#' # SessionInfo ####
#' ***
sessionInfo()
